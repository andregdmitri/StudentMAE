...
VMAMBA_DEPTH = int(os.getenv('VMAMBA_DEPTH', 24))
VMAMBA_EMBED_DIM = int(os.getenv('VMAMBA_EMBED_DIM', 192))
SSM_DIM = int(os.getenv('SSM_DIM', 16))
EXPAND_DIM = int(os.getenv('EXPAND_DIM', 2))    
